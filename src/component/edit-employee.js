...
function EmployeeEdit() {
    ...
    useEffect(() => {
        axios.get('https://shrouded-chamber-34460.herokuapp.com/employee/edit-employee/' + employeeId).then(res => {
    ...
    function handleOnSubmit(event) {
        ...
        axios.put('https://shrouded-chamber-34460.herokuapp.com/employee/edit-employee/' + employeeId, employeeData).then(res => {
